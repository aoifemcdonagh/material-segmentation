...
im = caffe.io.load_image('images/woodengardentable.jpg')
...
plt.subplot(1, 2, 2)
plt.imshow(out['prob'][0,22], cmap='tab20')
plt.
plt.title("Confidence map (probability of the top prediction at each location)")
plt.show()
